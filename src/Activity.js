    ...
    <div className={classes.root}>
      <AppBar position="static">
        <Toolbar className={classes.customizeToolbar}>  
            ...
            <Button aria-controls='menu' onClick={handleOpenMenu} style={{marginLeft:20, marginRight:20}}><FilterListIcon fontSize="medium"/> Filter</Button>
            
            <Menu style={{marginTop:'35px',}} id='menu' onClose={handleMenuClose} anchorEl={anchorEl} open={Boolean(anchorEl)}>
